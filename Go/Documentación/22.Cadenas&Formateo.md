# 22. Cadenas de Caracteres y Formateo en Go
...
- **Formatos de Fechas:** Go utiliza un diseño único para el formateo de fechas y horas. Debes usar un patrón basado en la referencia Mon Jan 2 15:04:05 MST 2006.
...
- **Formateo de Números:** Puedes formatear números con precisión de decimales.
...
- **fmt.Printf(): Imprime datos formateados en la salida estándar.**
...
- **fmt.Sprintf():** Retorna una cadena formateada, útil si deseas asignar el resultado a una variable.
...
- **fmt.Fscanf() y fmt.Scanf():** Estas funciones permiten formatear y leer datos de entrada desde archivos o la consola.
